        ...
        ClipRRect(
          ...
          child: CachedNetworkImage(
            ...
            placeholder: (_, __) => Container(
              ...
              child: Icon(isArtist ? Icons.person_rounded : Icons.album_rounded,
                  size: 40),
            ),
          ...
          return Column(
            ...
            children: [
              ...
              FutureBuilder<List<Song>>(
                future:
                    ref.read(artistRepositoryProvider).getArtistSongs(artistId),
                builder: (context, snapshot) {
...
void showPlaylistDetailsSheet(
  ...
  Future<List<Song>> fetchPlaylistTracks() async {
    if (playlistId.startsWith('mood_')) {
      ...
      final playlist =
          await ref.read(playlistRepositoryProvider).getPlaylist(playlistId);
