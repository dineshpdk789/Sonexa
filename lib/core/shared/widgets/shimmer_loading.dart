  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ShimmerLoading(
            width: 80, height: 10, borderRadius: BorderRadius.circular(4)),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          ShimmerLoading(
              width: 52, height: 52, borderRadius: BorderRadius.circular(8)),
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ShimmerLoading(
              width: 180, height: 24, borderRadius: BorderRadius.circular(6)),
          ...
          ShimmerLoading(
              width: 140, height: 24, borderRadius: BorderRadius.circular(6)),
          const SizedBox(height: 16),
          SizedBox(
            height: 180,
            child: ListView.separated(
