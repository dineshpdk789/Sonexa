...
import 'package:sonexa/shared/widgets/mini_player.dart';
...
class _FloatingNavBar extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(1, Icons.search_outlined, Icons.search_rounded, 'Search', cs),
          _buildMicItem(2, cs),
          _buildNavItem(3, Icons.library_music_outlined, Icons.library_music_rounded, 'Library', cs),
          _buildNavItem(4, Icons.more_horiz_rounded, Icons.more_horiz_rounded, 'More', cs),
        ],
      ),
    );
  }
  ...
  Widget _buildNavItem(
    ...
    final color = isSelected ? cs.primary : Colors.white.withOpacity(0.5);
