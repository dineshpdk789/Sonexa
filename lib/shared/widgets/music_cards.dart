...
import 'package:sonexa/shared/widgets/detail_sheets.dart';
...
class AlbumCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final cs = Theme.of(context).colorScheme;
    return GestureDetector(
      onTap: onTap ?? () => showAlbumDetailsSheet(context, ref, id, title, coverUrl, artist),
      child: SizedBox(
        width: 120,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
...
class ArtistCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final cs = Theme.of(context).colorScheme;
    return GestureDetector(
      onTap: onTap ?? () => showArtistDetailsSheet(context, ref, id, name, imageUrl),
      child: SizedBox(
        width: 110,
        child: Column(
          children: [
...
class PlaylistCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final cs = Theme.of(context).colorScheme;
    return GestureDetector(
      onTap: onTap ?? () => showPlaylistDetailsSheet(context, ref, id, title, coverUrl, description),
      child: SizedBox(
        width: 140,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
